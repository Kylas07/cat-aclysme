...
('Chat-rlatan', 8, 7, 'chat_rlatan.webp', 'Un chat trompeur et avare !'),
('Chat-r-d’assaut', 15, 6, 'chat_r_d_assaut.webp', 'Un puissant chat blindé, prêt à charger'),
('Chat-pristi', 9, 6, 'chat_pristi.webp', 'Un chat choqué, mais par quoi ?'),
...
('Chat-riot', 14, 5, 'chat_riot.webp', 'Un chat de transport'),
('Chat-pardeur', 9, 8, 'chat_pardeur.webp', 'Un chat voleur, expert dans l’art de la subtilisation'),
('Chat-rpie', 9, 7, 'chat_rpie.webp', 'Un chat volant dont ses serres sont bien aiguisées'),
...
('Chat-pot', 12, 6, 'chat_pot.webp', 'Un chat qui porte chance à ses alliés'),
('Chat-rlemagne', 14, 7, 'chat_rlemagne.webp', 'Un chat impérial, conquérant des territoires avec bravoure'),
('Chat-rmand', 8, 8, 'chat_rmand.webp', 'Un chat charmant, qui séduit ses adversaires par son élégance'),
